...
Both 96 GB workstation GPU GPUs have 96 GB GDDR7 VRAM each.
...
If the 70B FP8 model fails to load on sm_120 (sm_120 architecture) due to missing kernel support in the pinned vLLM version:

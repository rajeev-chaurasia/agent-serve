...
- GPUs: 2× NVIDIA RTX PRO 6000 Blackwell (SM120, 96 GB GDDR7 each)
...
- Clock lock: stock boost clocks (no manual lock applied; GPU boost is deterministic on Blackwell under sustained load)

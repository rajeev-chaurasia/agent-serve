...
agent-serve is a self-hosted LLM serving gateway for agentic traffic. It runs on bare metal with two NVIDIA RTX PRO 6000 Blackwell GPUs (96 GB GDDR7 each) and wraps three vLLM inference backends behind a single OpenAI-compatible HTTP endpoint.

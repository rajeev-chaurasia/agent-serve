...
**Labels:** `bug`, `documentation`, `hardware: blackwell`
...
**Environment:** RTX PRO 6000 Blackwell (sm_120), CUDA 12.8, vLLM 0.26.0, Docker 27.x
...
**Environment:** RTX PRO 6000 Blackwell (sm_120), CUDA 12.8, vLLM 0.26.0
